    ...
    <>
        ...
        <div className="container-fluid tm-mt-60">
            <div className="row mb-4">
                <h2 className="col-12 tm-text-primary">About Catalog-Z Website Template</h2>
            </div>
            <div className="row tm-mb-74 tm-row-1640">
                <div className="col-lg-5 col-md-6 col-12 mb-3">
                    <img src={about} alt="bn" className="img-fluid" />
                </div>
                <div className="col-lg-7 col-md-6 col-12">
                    <div className="tm-about-img-text">
                        <p className="mb-4">
                            ...
                            via PayPal. This will be helpful for us. We hope you like this Catalog-Z
                            photo / video template for your website. We are making new templates
                            regularly for you. Please come back and visit our{' '}
                        ...
                        <p>
                            Credits go to Pexels and Unsplash for photos and video used in this
                            template. Catalog-Z is free{' '}
                        ...
                        <p>
                            ...
                            website. You are <b>NOT allowed</b> to redistribute the downloadable
            ...
            <div className="row tm-mb-50">
                <div className="col-md-6 col-12">
                    <div className="tm-about-2-col">
                        <h2 className="tm-text-primary mb-4">Left side of 2-Column content</h2>
                        <p className="mb-4">
                            Pellentesque urna odio, scelerisque eu mauris vitae, vestibulum sodales
                            neque. Ut augue justo, tincidunt nec aliquet ac, cursus vel augue.
                            Suspendisse vel quam imperdiet, sodales tellus sed, ullamcorper lorem.
                        </p>
                        <p>
                            Suspendisse id consequat risus. Aliquam varius posuere nunc, nec
                            imperdiet neque condimentum at. Aenean porta eleifend venenatis. Orci
                ...
                <div className="col-md-6 col-12">
                    <div className="tm-about-2-col">
                        <h2 className="tm-text-primary mb-4">Right-side Title goes here</h2>
                        <p className="mb-4">
                            Pellentesque urna odio, scelerisque eu mauris vitae, vestibulum sodales
                            neque. Ut augue justo, tincidunt nec aliquet ac, cursus vel augue.
                            Suspendisse vel quam imperdiet, sodales tellus sed, ullamcorper lorem.
                ...
                <div className="col-md-4 col-12">
                    <div className="tm-about-3-col">
                        ...
                        <p className="mb-4">
                            ...
                            egestas ipsum sapien, hendrerit ultricies nisi viverra eget. Vestibulum
                            in tortor eget elit rutrum interdum.{' '}
                        </p>
                        <p>
                            Cras auctor velit urna, et feugiat ex tincidunt ut. Sed viverra, elit at
                            pulvinar tristique, sem quam vehicula dolor, sed scelerisque augue
                            mauris non dolor.
                        </p>
                    </div>
                </div>
                <div className="col-md-4 col-12">
                    <div className="tm-about-3-col">
                        ...
                        <p className="tm-mb-50">
                            ...
                            Phasellus sodales placerat ipsum ac auctor. Mauris molestie blandit
                            turpis. Mauris ante tellus, feugiat nec metus non, bibendum semper
                            velit.
                        </p>
                ...
                <div className="col-md-4 col-12">
                    <div className="tm-about-3-col">
                        ...
                        <p className="mb-4">
                            ...
                            fames ac turpis egestas. Donec nec est tincidunt, rhoncus nulla sit
                            amet, imperdiet augue.{' '}
                        </p>
                        <p>
                            Phasellus sodales placerat ipsum ac auctor. Mauris molestie blandit
                            turpis. Mauris ante tellus, feugiat nec metus non, bibendum semper
